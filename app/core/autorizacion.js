...
export const ACCIONES = {
  ...
  // Compras y proveedores llevan precios de compra — el mismo dato que
  // protege VER_COSTOS, así que viven del mismo lado de la pared.
...
const PERMISOS = {
  ...
  [ROLES.DEPOSITO]: new Set([
    ...
    A.GESTIONAR_ZONAS, A.GESTIONAR_COMPRAS, A.PREPARAR_ENCARGUE, A.VINCULAR_ENCARGUE_ESPECIAL,
